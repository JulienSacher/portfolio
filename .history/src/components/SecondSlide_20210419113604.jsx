        ...
        <Container className="mt-4">
            ...
            <div className="aboutMe__container"> 
                <Row className="d-flex align-items-center">
                    ...
                    <Col sm={6}> 
                        <h2 className="aboutMe__sub text-center pt-4 pr-4">Languages & Frameworks</h2>
                        <div className="progress mr-4">
                        <div className="progress__value pr">
                            <p className="progress__p">HTML/CSS <span className="text-black float-right">60%</span></p>
                        </div>
                    </div>
                    </Col>
                </Row>
