            ...
            <div className="aboutMe__container"> 
                <Row className="d-flex align-items-center">
                    ...
                    <Col sm={6}> 
                        ...
                        <div className="progress ml-auto m-auto mb-2">
                            <div className="progress__value3">
                                <p className="progress__p">REACT NATIVE <span className="text-black float-right">70%</span></p>
                            </div>
                        </div>
                        <div className="progress ml-auto m-auto mt-2">
                            <div className="progress__value4">
                                <p className="progress__p">BOOTSTRAP <span className="text-black float-right">70%</span></p>
                            </div>
                        </div>
