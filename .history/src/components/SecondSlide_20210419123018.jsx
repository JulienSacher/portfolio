                    ...
                    <Col sm={6}> 
                        ...
                        <div className="progress ml-auto mr-auto mb-3">
                            <div className="progress__value8">
                                <p className="progress__p">VUE JS <span className="text-black float-right">30%</span></p>
                            </div>
                        </div>
                        <div className="progress ml-auto mr-auto">
                            <div className="progress__value9">
                                <p className="progress__p">PYTHON <span className="text-black float-right">25%</span></p>
                            </div>
                        </div>
